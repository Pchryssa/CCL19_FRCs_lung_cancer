...
### Dotplot CD8`r knitr::asis_output("\U207A")` T cell subsets (Supplementary Figure 8E)
...
#### Enriched in DTR$^`r knitr::asis_output("\U2212")`$ Ccr7`r knitr::asis_output("\U207A")` T cells (Supplementary Figure 8F)
```{r Ccr7 T}
# Step 1 : Set output directory
subDir <- "GSEA_CCR7_T/"
saving_path <- paste0(basedir,"/output/")
